...
public class Video {
    ...
    public String id,url,img,title,title_en,title_ar,recorder_date,first_start,start_time,stop_time,duration,islocked,tags,bitrates,smil,youtube_link,youtube_views,wowza_views,today_views,description_en,description_ar,publish,publish_time,category_id,channel_id,smartTV,featured,premium,vip,parental_control,vod,catchup,edited,order,schedule,eschedule,protectedd,deleted,create_time,update_time,user_id,geo_status,geo_countries,geo_zone,autoplay,external_url,author_id,shub_id,group_tags,from_featured,to_featured,featured_schedule,aid,author_name,author_img,cat_id,cat_en,cat_ar;

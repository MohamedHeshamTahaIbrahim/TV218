 ...
 */
public class NewsTop12 {

    String TAG = "NewsTop12 Controller";
    ResultStatus resultobject;
    Context context;

    public NewsTop12(Context con, Object obj)
    {
        context = con;
    ...
    public void getnewscategorieswebservice() {
        ...
        VolleyJSONObjectRequest areasrequest = new VolleyJSONObjectRequest(
                context.getResources().getString(R.string.URL_NEWS_TOP_12)+context.getResources().getString(R.string.API_KEY),

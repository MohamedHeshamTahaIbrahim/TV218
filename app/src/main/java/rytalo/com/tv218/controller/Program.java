...
public class Program {
    ...
    String TAG = "Program Controller";
    ResultStatus resultobject;
    Context context;

    public Program(Context con, Object obj)
    {
        context = con;
    ...
    public void getnewscategorieswebservice() {
        ...
        VolleyJSONObjectRequest areasrequest = new VolleyJSONObjectRequest(
                context.getResources().getString(R.string.URL_PROGRAMS)+context.getResources().getString(R.string.PROGRAMS_KEY),

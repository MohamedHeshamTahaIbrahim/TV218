...
public class Opinion {
    ...
    String TAG = "News Controller";
    ResultStatus resultobject;
    Context context;

    public Opinion(Context con, Object obj)
    {
        context = con;
    ...
    public void getnewscategorieswebservice() {
        ...
        VolleyJSONObjectRequest areasrequest = new VolleyJSONObjectRequest(
                context.getResources().getString(R.string.URL_NEWS_OPENION)+context.getResources().getString(R.string.API_KEY),

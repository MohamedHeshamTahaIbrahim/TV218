...
public class NewsCategories {
    ...
    String TAG = "categories Controller";
    ResultStatus resultobject;
    Context context;

    public NewsCategories(Context con,Object obj)
    {
        context = con;
    ...
    public void getnewscategorieswebservice() {
        ...
        VolleyJSONArrayRequest areasrequest = new VolleyJSONArrayRequest(
                context.getResources().getString(R.string.URL_NEWS_CATEGORIES)+ context.getResources().getString(R.string.API_KEY) + "&parameters[vid]=3",
